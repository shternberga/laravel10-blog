            ...
            <div class="space-y-4">
                ...
                <div class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
                    ...
                    <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="body-input" class="sr-only">{{ __('Body') }}</label>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div>
                                <button type="submit" class="rounded font-bold p-1 btn-sm bg-indigo-500 hover:bg-indigo-600 text-white whitespace-nowrap">{{ __('Submit') }} &gt;</button>
                            </div>
                        </div>
                    </form>
                </div>
